  ...
  return (
    <section id="about" className="hero">
      ...
      <p className="hero__intro">
        Protopolis Lab investigates and prototypes civic protocols and emerging
        technologies that enable collective life to flourish {"\u2014"} in
        tomorrow{"\u2019"}s polis, networks, and habitats.
      </p>
